...
pub fn score_hotspots(
    ...
    files
        ...
        .map(|file| {
            ...
            let hotspot_score = churn_score * weights.churn
            ...
            HotspotResult {
                ...
                details: HotspotDetails {
                    ...
                    top_author: silo
                        .map_or_else(|| "unknown".to_string(), |d| d.top_author.clone()),
...
mod tests {
        ...
        files
            ...
            .map(|f| {
                (
                    f.clone(),
                    SiloData {
                        top_author: "dev".to_string(),
                        top_author_percent: 0.0,
                        author_count: 1,
                    },
                )
            })
    ...
    fn test_all_zero_signals_gives_zero_score() {
        ...
        assert_eq!(
            results[0].hotspot_score, 0.0,
            "All-zero signals should produce score 0"
        );
    ...
    fn test_output_count_matches_input() {
        ...
        assert_eq!(
            results.len(),
            files.len(),
            "Output should have one entry per input file"
        );
    }
    ...
    fn test_max_signals_produces_critical_tier() {
        ...
        assert!(
            results[0].hotspot_score > 75.0,
            "All signals at max should produce CRITICAL score"
        );
